...
- `scripts/bootstrap.py` deterministic template initializer: renames the
  package and replaces every placeholder (`pytest-tattletale`, `pytest_tattletale`,
...
- Simplified `src/pytest_tattletale/__init__.py`'s version resolution to the
...
[Unreleased]: https://github.com/tomada1114/pytest-tattletale/commits/main
